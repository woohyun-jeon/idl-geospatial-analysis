PRO Sentinel1EnhancedPSInSAR
  ...
  ; Enhanced PS-InSAR step 1. generate connection graph
  ...
  ; Enhanced PS-InSAR step 2. generate interferogram
  ...
  ; Enhanced PS-InSAR step 3. apply adaptive filtering
  task_5 = ENVITask('SARsInSARStackPSAdaptiveFiltering')
  task_5.auxiliary_file_name = task_4.auxiliary_processing_info_file
  task_5.shp_method = 'KS'
  task_5.filtering_method = 'PCA'
  task_5.is_sequential = !FALSE
  task_5.Execute

  ; Enhanced PS-InSAR step 4. apply first inversion
  task_6 = ENVITASK('SARsInSARStackPSInversionStep1')
  task_6.auxiliary_file_name = task_5.auxiliary_processing_info_file
  task_6.velocity_step = 1.0
  task_6.minimum_velocity = -25.0
  task_6.maximum_velocity = 25.0
  task_6.height_step = 2.0
  task_6.minimum_height = -70.0
  task_6.maximum_height = 70.0
  task_6.ps_atmospheric_area_km = 25.0
  task_6.perc_area_overlap = 30.0
  task_6.nbr_of_candidates = 5.0
  task_6.rebuild_all = !TRUE
  task_6.generate_ql = !FALSE
  task_6.root_uri_for_output = task_0.root_uri_for_output
  task_6.Execute

  ; Enhanced PS-InSAR step 5. apply second inversion
  task_7 = ENVITASK('SARsInSARStackPSInversionStep2')
  task_7.auxiliary_file_name = task_6.auxiliary_processing_info_file
  task_7.atmosphere_hp_days = 365.0
  task_7.atmosphere_lp_meters = 1200.0
  task_7.rebuild_all = !TRUE
  task_7.generate_ql = !FALSE
  task_7.root_uri_for_output = task_0.root_uri_for_output
  task_7.Execute

  ; Enhanced PS-InSAR step 6. apply geocoding
  task_8 = ENVITASK('SARsInSARStackPSGeocode')
  task_8.auxiliary_file_name = task_7.auxiliary_processing_info_file
  task_8.dem_sarscapedata = task_2.output_sarscapedata
  task_8.ps_coherence_threshold = 0.59999999999999996
  task_8.ps_generate_kml = !FALSE
  task_8.make_geocoded_shape = !TRUE
  task_8.ps_max_points_in_shape = 10000000.0
  task_8.make_geocoded_raster = !TRUE
  task_8.make_slant_ps_shape = !FALSE
  task_8.force_rebuild_all = !TRUE
  task_8.refinement_stacking = 'StackAllProductsRefinement'
  task_8.radius = 20.0
  task_8.refinement_res_phase_poly_degree = '3'
  task_8.generate_vertical = !TRUE
  task_8.generate_max_slope = !FALSE
  task_8.generate_user_custom = !FALSE
  task_8.geocode_rg_grid_size = 20.0
  task_8.geocode_az_grid_size = 20.0
  task_8.output_cartographic_system = ["GEO-GLOBAL","","GEO","","WGS84","","0.0000000"]
