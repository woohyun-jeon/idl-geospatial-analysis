PRO Sentinel1EnhancedSBAS
  ...
  ; ===========================
  ; Enhanced SBAS-InSAR procedure
  ; ===========================
  sbas_auxfile = DIALOG_PICKFILE(TITLE = 'Select auxiliary.sml file in the SBAS output directory', PATH = outDIR, FILTER = 'auxiliary.sml')

  ; ===========================
  ; Enhanced SBAS-InSAR procedure
  ; ===========================
  ; step 01. get connection graph
  task_8 = ENVITask('SARsInSARConnectionGraphESBAS')
  task_8.auxiliary_sbas_name = sbas_auxfile
  task_8.generate_ql = !FALSE
  task_8.root_uri_for_output = task_0.root_uri_for_output
  task_8.execute

  ; step 02. apply interferogram generation
  task_9 = ENVITASK('SARsInSARStackESBASInterferogramGeneration')
  task_9.auxiliary_file_name = task_8.auxiliary_processing_info_file
  task_9.dem_sarscapedata = task_2.output_sarscapedata
  task_9.multilooking_diff_interf = !FALSE
  task_9.cc_range_win_number_cc = 8.0
  task_9.cc_azimuth_win_number_cc = 2.0
  task_9.coregistration_with_dem = !TRUE
  task_9.output_cartographic_system = ["GEO-GLOBAL","","GEO","","WGS84","","0.0000000"]
  task_9.generate_ql = !FALSE
  task_9.root_uri_for_output = task_0.root_uri_for_output
  task_9.Execute

  ; step 03. apply inversion
  task_10 = ENVITask('SARsInSARStackESBASInversion')
  task_10.auxiliary_file_name = task_9.auxiliary_processing_info_file
  task_10.atmosphere_hp_days = 365.0
  task_10.atmosphere_lp_meters = 1200.0
  task_10.root_uri_for_output = task_0.root_uri_for_output
  task_10.Execute

  ; step 04. apply geocoding
  task_11 = ENVITASK('SARsInSARStackESBASGeocode')
  task_11.auxiliary_file_name = task_10.auxiliary_processing_info_file
  task_11.dem_sarscapedata = task_2.output_sarscapedata
  task_11.ps_coherence_threshold = 0.59999999999999996
  task_11.ps_generate_kml = !FALSE
  task_11.make_geocoded_shape = !TRUE
  task_11.make_geocoded_raster = !TRUE
  task_11.generate_vertical = !TRUE
  task_11.geocode_rg_grid_size = 20.0
  task_11.geocode_az_grid_size = 20.0
  task_11.output_cartographic_system = ["GEO-GLOBAL","","GEO","","WGS84","","0.0000000"]
  task_11.generate_ql = !FALSE
  task_11.root_uri_for_output = task_0.root_uri_for_output
  task_11.Execute
